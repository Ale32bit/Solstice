                ...
                .executes(context -> {
                    ...
                    if(warpList.isEmpty()) {
                        context.getSource().sendFeedback(() -> Format.parse(
                                ServiceProvider.locale().commands.warp.noWarps,
                                sourceContext
                        ), false);
                        return 1;
                    }
                    ...
                    var comma = Format.parse(ServiceProvider.locale().commands.warp.warpsComma);
                    for(var i = 0; i < warpList.size(); i++) {
                        ...
                        listText = listText.append(Format.parse(
                                ServiceProvider.locale().commands.warp.warpsFormat,
                                sourceContext,
                                placeholders
                        ));
                    }
                    ...
                    context.getSource().sendFeedback(() -> Format.parse(
                            ServiceProvider.locale().commands.warp.warpList,
                            sourceContext,
                            placeholders
                    ), false);
