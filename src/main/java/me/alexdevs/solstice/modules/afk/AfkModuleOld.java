...
public class AfkModuleOld extends ModuleBase {
    public static final String ID = "afk";
    public static Text afkTag;
    private final ConcurrentHashMap<UUID, PlayerActivityStateOld> playerActivityStates = new ConcurrentHashMap<>();
...
//        this.commands.add(new ActiveTimeCommand(this));
    ...
    private void register() {
        ...
        ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
            ...
            playerActivityStates.put(player.getUuid(), new PlayerActivityStateOld(player, server.getTicks()));
        });
    ...
    private void updatePlayer(ServerPlayerEntity player, MinecraftServer server) {
        ...
        var playerState = playerActivityStates.computeIfAbsent(player.getUuid(), uuid -> new PlayerActivityStateOld(player, currentTick));
