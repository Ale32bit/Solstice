...
public class AnvilCommand extends ModCommand<UtilitiesModule> {
    public AnvilCommand(UtilitiesModule module) {
        super(module);
    }
        ...
        return literal(name)
                ...
                .executes(context -> {
                    ...
                    var screen = new SimpleMenuProvider(
                            (syncId, inventory, p) ->
                                    new VirtualAnvilScreenHandler(syncId, inventory, ContainerLevelAccess.create(player.level(), player.blockPosition())),
