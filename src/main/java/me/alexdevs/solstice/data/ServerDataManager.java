...
public class ServerDataManager {
    ...
    public ServerDataManager(Path basePath) {
        this.basePath = basePath;
        loader = getLoader(getDataPath());
    }

    public Path getDataPath() {
        return basePath.resolve("server.dat");
    }
    ...
    public void prepareData() throws ConfigurateException {
        ...
        serverNode.mergeFrom(defaults);
        loader.save(serverNode);
        this.dataNode = serverNode;
        loadData(false);
    }
}
