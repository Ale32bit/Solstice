...
public final class SolsticeEvents {
    ...
    public static final Event<Reload> RELOAD = EventFactory.createArrayBacked(
            Reload.class, callbacks ->
                    (instance) -> {
    ...
    public static final Event<Welcome> WELCOME = EventFactory.createArrayBacked(
            Welcome.class, callbacks ->
                    (player, server) -> {
    ...
    public static final Event<UsernameChange> USERNAME_CHANGE = EventFactory.createArrayBacked(
            UsernameChange.class, callbacks ->
     ...
     */
    @Deprecated
    public static final Event<PlayerCommand> PLAYER_COMMAND = EventFactory.createArrayBacked(
            PlayerCommand.class, callbacks ->
                    (player, command) -> {
