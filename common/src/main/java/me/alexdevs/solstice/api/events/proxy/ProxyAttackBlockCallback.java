 ...
 * </ul>
 */
public interface ProxyAttackBlockCallback {
    Event<ProxyAttackBlockCallback> EVENT = EventFactory.createArrayBacked(
            ProxyAttackBlockCallback.class, (listeners) -> (player, level, hand, pos, direction) -> {
                for (ProxyAttackBlockCallback event : listeners) {
